...
DIALOG = MainDialog(RECOGNIZER,SIDE_EFFECTS_DIALOG,BROCHURE_DIALOG,NEARBY_PHARMACY_DIALOG,REGISTRATION_DIALOG,LOGIN_DIALOG,INSERT_MEDICINE_DIALOG,DELETE_MEDICINE_DIALOG,UPDATE_MEDICINE_DIALOG,WHAT_IS_DIALOG,HOW_TAKE_DIALOG,BEFORE_TAKE,USER_STATE)
